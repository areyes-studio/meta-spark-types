...
*/ 
shoulder: PixelPointSignal;
/** 
* 
```
(get) elbow: PixelPointSignal
(set) (Not Available)
```
...
*/ 
elbow: PixelPointSignal;
/** 
* 
```
(get) wrist: PixelPointSignal
(set) (Not Available)
```
