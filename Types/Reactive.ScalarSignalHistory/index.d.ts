...
declare interface ScalarSignalHistory {
/** 
* 
```
(get) length: number
...
* 
 *  
 * at(index: number): ScalarSignal
 *  
 * 
 * Returns an `ScalarSignal` for the history value at given index.
 * 
 ...
 *  
 * 
 * Returns an `ScalarSignal` for the history value at given frame relative to current one.
 * 
