...
declare interface StringSignalHistory {
/**
* 
```
(get) length: number
...
* 
 *  
 * at(index: number): StringSignal
 *  
 * 
 * Returns an `StringSignal` for the history value at given index.
 * 
 ...
 *  
 * 
 * Returns an `StringSignal` for the history value at given frame relative to current one.
 * 
