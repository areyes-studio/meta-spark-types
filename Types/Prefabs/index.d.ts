 ...
 */
static findFirst(name: string): Promise<PrefabBase | null>;
 ...
 */
static findUsingPattern(namePattern: string, config?: {limit: number}): Promise<Array<PrefabBase>>;
 ...
 */
static getAll(): Promise<Array<PrefabBase>>;
