...
declare interface PointSignalHistory {
/** 
* 
```
(get) length: number
...
* 
 *  
 * at(index: number): PointSignal
 *  
 * 
 * Returns an `PointSignal` for the history value at given index.
 * 
...
* 
 *  
 * frame(relativeFrame: number): PointSignal
 *  
 * 
 * Returns an `PointSignal` for the history value at given frame relative to current one.
 * 
