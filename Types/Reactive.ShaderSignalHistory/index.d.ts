...
declare interface ShaderSignalHistory {
/** 
* 
```
(get) length: number
...
* 
 *  
 * at(index: number): ShaderSignal
 *  
 * 
 * Returns an `ShaderSignal` for the history value at given index.
 * 
 ...
 *  
 * 
 * Returns an `ShaderSignal` for the history value at given frame relative to current one.
 * 
